...
export const ROBUSTNESS = [{"system": "model:gliner2-fastino", "Easy": 85.33, "Medium": 76.37, "Hard": 60.7, "Extreme": 36.27}, {"system": "model:gliner2-hivetrace-omni", "Easy": 74.82, "Medium": 71.31, "Hard": 46.91, "Extreme": 36.29}, {"system": "model:pplx", "Easy": 94.22, "Medium": 83.22, "Hard": 64.38, "Extreme": 25.99}, {"system": "model:nuner-zero", "Easy": 75.36, "Medium": 69.41, "Hard": 53.75, "Extreme": 26.36}] as const;
export const DOMAINS = [{"system": "model:gliner2-fastino", "pii": 79.77, "secrets": 65.92}, {"system": "model:gliner2-hivetrace-omni", "pii": 75.42, "secrets": 44.33}, {"system": "model:pplx", "pii": 73.99, "secrets": 91.21}, {"system": "model:nuner-zero", "pii": 71.65, "secrets": 58.09}] as const;
...
export const HARDWARE = [
  {
    ...
    name: "CPU shortlist",
    value: "—",
    note: "PPLX, Fastino, Nym-small and secret scanners are candidates. FP32, INT8 and ONNX quality differ, so there is no validated stack winner yet."
  },
  {
    id: "cuda",
    label: "NVIDIA CUDA",
    ...
    value: "92.96%",
    note: "Best saved GPU-eligible union in the frozen results. 16,011 residual spans; stack latency and peak memory were not measured end-to-end."
  },
  {
    id: "mps",
    label: "Apple MPS",
    ...
    name: "Apple GPU",
    value: "—",
    note: "CPU and CUDA measurements do not establish Apple MPS throughput or quality parity. A dedicated MPS benchmark is required."
  }
] as const;

export const RECOMMENDATIONS = [
  {
    eyebrow: "Solo baseline",
    name: "GLiNER2 Fastino",
    value: "79.86%",
    metric: "Fully Hidden",
    note: "5.88% extra masking · 45,819 residual spans",
    evidence: "41 datasets · single detector"
  },
  {
    eyebrow: "GPU-eligible stack",
    name: "PPLX + Fastino + mmBERT",
    value: "92.96%",
    metric: "Fully Hidden",
    note: "16,011 residual spans · end-to-end stack latency not measured",
    evidence: "41 datasets · CUDA eligible"
  },
  {
    eyebrow: "Maximum measured",
    name: "PPLX + Fastino + BardsAI + mmBERT",
    value: "94.40%",
    metric: "Fully Hidden",
    note: "19.82% extra masking · 12,728 residual spans",
    evidence: "41 datasets · hybrid CPU + GPU"
  }
] as const;
